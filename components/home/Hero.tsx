      ...
      <div className="container-page relative py-32 sm:py-32 lg:py-36 min-h-[85vh] sm:min-h-0 flex flex-col justify-center">
        ...
        >
          ...
          <p className="hidden sm:block text-ivory/80 text-lg mt-6 max-w-xl leading-relaxed">
            Hampton Roads Epoxy installs premium metallic, quartz, and epoxy
            flake flooring for garages, homes, and businesses — built to
            impress and engineered to last.
          </p>
          <p className="sm:hidden text-ivory/80 text-sm mt-2 max-w-xl leading-relaxed">
            Premium metallic, quartz &amp; epoxy flake flooring — built to impress.
          </p>
