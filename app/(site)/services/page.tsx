...
export const metadata: Metadata = {
  ...
  description:
    "Explore Hampton Roads Epoxy's metallic epoxy, quartz epoxy, and classic epoxy flooring services for residential and commercial spaces across Hampton Roads.",
